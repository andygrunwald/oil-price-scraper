...
func NewStatusHandler(s *weatherscraper.WeatherScraper, sched *scheduler.Scheduler, db *database.DB) *StatusHandler {
...
func (h *StatusHandler) getDatabaseStatus(ctx context.Context) models.WeatherDatabaseStatus {
